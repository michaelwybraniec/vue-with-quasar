        ...
        >
          <q-btn-group unelevated>
            ...
            <q-btn
              ...
              label="Name"
              @click="onSort('name')"
              :color="this.sort.attribute === 'name' ? 'negative': 'primary'"
            >
              <div v-if="this.sort.attribute === 'name'">
                <q-icon v-if="this.sort.inverse" name="keyboard_arrow_up" />
            ...
            <q-btn
              ...
              label="Stars"
              @click="onSort('stars')"
              :color="this.sort.attribute === 'stars' ? 'negative': 'primary'"
            >
      ...
      if (attribute === "name") {
        ...
        return array.sort(function(a, b) {
          return a.powerstars[6].value.rounded === b.powerstars[6].value.rounded
            ...
            : inverse
            ? +(
                a.powerstars[6].value.rounded < b.powerstars[6].value.rounded
              ) || -1
            : +(
                a.powerstars[6].value.rounded > b.powerstars[6].value.rounded
              ) || -1;
